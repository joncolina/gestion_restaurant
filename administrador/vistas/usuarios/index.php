                                ...
                                <div class="card-body">
                                    <form id="form-filtro" onsubmit="event.preventDefault()">
                                        <div class="input-group input-group-sm mb-2">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text w-100px">Restaurant</span>
                                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group mb-0">
                    <label for="input-nuevo-restaurant" class="mb-0">Elija el restaurant:</label>
                    <select name="idRestaurant-nuevo" id="input-nuevo-restaurant" class="form-control">
                        <?php
                            foreach($restaurantes as $restaurant)
                            {
                                ?>
